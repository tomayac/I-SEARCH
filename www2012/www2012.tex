...
\begin{figure}
  \centering
    \subfloat[][Multimodal query consisting of \emph{geolocation}, \emph{video}, \emph{emotion}, and \emph{sketch} (in progress).]{
      \includegraphics[width=0.75\columnwidth]{./resources/isearch.jpg}
      \label{fig:isearch}}
    \qquad
    \subfloat[][Running on some mobile devices with different screen sizes and operating systems.]{
      \includegraphics[width=0.75\columnwidth]{./resources/devices.jpg}
      \label{fig:devices}}
...
We maintain a bleeding-edge demonstration server\footnote{Demonstration: \url{http://isearch.ai.fh-erfurt.de/}}, and a screencast\footnote{Screencast: \url{http://youtu.be/-chzjEDcMXU}}
